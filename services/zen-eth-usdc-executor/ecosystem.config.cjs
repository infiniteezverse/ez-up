 ...
 *   pm2 delete ecosystem.config.cjs     # Stop and remove from PM2
...
module.exports = {
  ...
  deploy: {
    production: {
      ...
      'post-deploy': 'cd services/zen-eth-usdc-executor && npm install && pm2 startOrRestart ecosystem.config.cjs --env production && pm2 save'
    }
  }
};
